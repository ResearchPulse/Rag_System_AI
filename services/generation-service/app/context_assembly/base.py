...
class AssembledContext(BaseModel):
    """Represents a curated, ordered, and compressed context payload ready for prompt injection."""
...
class BaseContextAssembler(ABC):
    ...
    def assemble(
        ...
        """Selects, orders, deduplicates, and compresses context for LLM prompt."""
        pass
